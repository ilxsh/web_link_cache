...
define("confluence/storage-manager",["confluence/meta","confluence/api/logger","window"],function(l,h,d){return function(m,n){var k=l.get("remote-user"),e=m+"."+(k?k+".":"")+n,f=!1,p=/\d+#/,g=function(a){if(!f)return null;var c,b=d.localStorage.getItem(e+"."+a);if(c=p.exec(b))if(b=b.replace(c[0],""),+new Date>c[0].replace("#",""))return d.localStorage.removeItem(e+"."+a),null;return b};try{f="localStorage"in d&&null!==d.localStorage}catch(a){h.log("Browser does not support localStorage: the 'confluence/confluence-storage-manager' module will not work.")}return{getItem:g,
doesContain:function(a){return!!g(a)},getItemAsBoolean:function(a){a=g(a);return"false"==a?!1:"true"==a?!0:!!a},setItem:function(a,c,b){f&&(b=(b=1E3*(b||0))?+new Date+b+"#":"",d.localStorage.setItem(e+"."+a,b+c))},setItemQuietly:function(a,c,b){try{this.setItem(a,c,b)}catch(q){h.debug("Unable to write to localStorage. key: ",a,", value: ",c,", cause: ",q)}},removeItem:function(a){f&&d.localStorage.removeItem(e+"."+a)}}}});
...
define("confluence/autocomplete-user",["jquery","ajs","document","confluence-rest/confluence-rest"],function(b,h,n,p){return function(g){g=g||n.body;var q=function(d){if(!d||!d.result)throw Error("Invalid JSON format");b.each(d.result,function(a,b){b.key=b.username||b.name;"group"===b.type&&(b.title=b.name,b.link=[],b.thumbnailLink={href:h.contextPath()+"/images/icons/avatar_group_48.png"})});var e=[];e.push(d.result);return e};b.each(["user","group","user-or-group"],function(d,e){b("input.autocomplete-"+
e+'[data-autocomplete-user-or-group-bound!\x3d"true"]',g).each(function(){var a=b(this).attr("data-autocomplete-user-or-group-bound","true").attr("autocomplete","off"),d=a.attr("data-max")||10,g=a.attr("data-alignment")||"left",k=a.attr("data-dropdown-target"),f=null,l=a.attr("data-target"),h=a.attr("data-show-unlicensed"),m=l&&b(l);k?f=b(k):(f=b("\x3cdiv\x3e\x3c/div\x3e"),a.after(f));a.attr("data-resize-to-input")&&(f.width(a.outerWidth()),f.addClass("resize-to-input"));f.addClass("aui-dd-parent autocomplete");
a.quicksearch(p.REST.getBaseUrl()+"search/"+e+".json",function(){a.trigger("open.autocomplete-user-or-group");"user"===e&&a.trigger("open.autocomplete-user")},{makeParams:function(a){return{"max-results":d,query:a,"show-unlicensed":h}},dropdownPlacement:function(a){f.append(a)},makeRestMatrixFromData:q,addDropdownData:function(b){if(!b.length){var c=a.attr("data-none-message");c&&b.push([{name:c,className:"no-results",href:"#"}])}return b},ajsDropDownOptions:{alignment:g,displayHandler:function(a){return a.name},
selectionHandler:function(d,c){c.find(".search-for").length?(a.trigger("selected.autocomplete-user-or-group",{searchFor:a.val()}),"user"===e&&a.trigger("selected.autocomplete-user",{searchFor:a.val()})):(c.find(".no-results").length||(c=b("span:eq(0)",c).data("properties"),m?(a.val(c.restObj.title),m.val(c.restObj.key)):a.val(c.restObj.key),a.trigger("selected.autocomplete-user-or-group",{content:c.restObj}),"user"===e&&a.trigger("selected.autocomplete-user",{content:c.restObj})),this.hide(),d.preventDefault())}}})})})}});
require("confluence/module-exporter").safeRequire("confluence/autocomplete-user",function(b){Confluence.Binder.autocompleteUserOrGroup=b});
}catch(e){WRMCB(e)};
;
try {
...
define("confluence/hover-user",["jquery","confluence/dark-features","confluence/content-hover","ajs","confluence/meta"],function(b,g,l,f,h){var d=[],k=f.contextPath();if(h.get("remote-user")&&!h.get("remote-user-has-licensed-access"))return b.noop;var n=function(a){var c=d[a],e={username:c,target:this};b(self).trigger("hover-user.open",e);b(".ajs-menu-bar",this).ajsMenu();b(".follow, .unfollow",this).each(function(){var a=b(this).click(function(d){if(!a.hasClass("waiting")){var m=a.hasClass("unfollow")?
"/unfollowuser.action":"/followuser.action";a.addClass("waiting");f.safe.post(k+m+"?username\x3d"+encodeURIComponent(c)+"\x26mode\x3dblank",{},function(){a.removeClass("waiting");a.parent().toggleClass("follow-item").toggleClass("unfollow-item");b(self).trigger("hover-user.follow",e)});return f.stopEvent(d)}})});g.isEnabled("fabric.profile.redirect")&&b("a.confluence-userlink,a.user-profile-link",this).each(function(){var a=this.href;a.includes("?src\x3d")||a.includes("\x26src\x3d")||(this.href=a.concat(a.includes("?")?
"\x26":"?","src\x3dprofilecard"));this.target||(this.target="_blank")})},p=g.isEnabled("show.business.group.in.user.hover");return function(){b("span.user-hover-trigger, a.confluence-userlink, img.confluence-userlink, a.userLogoLink").filter("[data-user-hover-bound!\x3d'true']").each(function(){var a=b(this),c=a.attr("data-username");a.attr("title","").attr("data-user-hover-bound","true");b("img",a).attr("title","");var e=b.inArray(c,d);-1===e&&(d.push(c),e=b.inArray(c,d));a.addClass("userlink-"+
e)});b.each(d,function(a){var c=k+"/users/userinfopopup.action?username\x3d"+encodeURIComponent(d[a]);p&&(c+="\x26profileGroups\x3dbusiness");l(b(".userlink-"+a),a,c,n)})}});require("confluence/module-exporter").exportModuleAsGlobal("confluence/hover-user","Confluence.Binder.userHover");
}catch(e){WRMCB(e)};
;
try {
