...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_ignored) {
  return '<p class="comment-user-logo">' + ((opt_data.userInfo.accountId == null) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/wiki/s/-312201113/6452/07e0bf3d16ce5e86ee5db73d7aedcb6d46cffb43/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml('User icon') + ': ' + soy.$$escapeHtml('Anonymous') + '" title="' + soy.$$escapeHtml('Anonymous') + '">' : (opt_data.userInfo.profilePicture.isDefault) ? '<a class="userLogoLink" data-account-id="' + soy.$$escapeHtml(opt_data.userInfo.accountId) + '" href="' + soy.$$escapeHtml("/wiki") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml('Add a picture of yourself') + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/wiki/s/-312201113/6452/07e0bf3d16ce5e86ee5db73d7aedcb6d46cffb43/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml('User icon') + ': ' + soy.$$escapeHtml('Add a picture of yourself') + '"></a>' : '<a class="userLogoLink" data-account-id="' + soy.$$escapeHtml(opt_data.userInfo.accountId) + '" href="/people/' + soy.$$escapeHtml(opt_data.userInfo.accountId) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.userInfo.profilePicture.path) + '" alt="' + soy.$$escapeHtml('User icon') + ': ' + soy.$$escapeHtml(opt_data.userInfo.displayName) + '" title="' + soy.$$escapeHtml(opt_data.userInfo.displayName) + '"></a>') + '</p>';
};
if (goog.DEBUG) {
