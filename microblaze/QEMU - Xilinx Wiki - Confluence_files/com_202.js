...
"autocomplete-singleuser",g=e(m.MacroBrowser.macroParameter()),k=e("input[type\x3d'text']",g);k.addClass(f).attr("data-none-message","Not found");b.required&&k.keyup(l.processRequiredParameters);b.multiple?(w(g,!0,!0),a.setValue=function(a){k.val(a);a=a.split(",");for(var b=[],g=[],f=0,h=a.length;f<h;f++)b.push(function(a){return e.getJSON(u.CONTEXT_PATH+"/rest/api/user?accountId\x3d"+a).done(function(b){b&&b.accountId?g.push({id:b.accountId,text:b.displayName,
imgSrc:b.profilePicture.path||d}):g.push(c(a))}).fail(function(b){t.logError("Cannot parse user data for macro browser field with: "+b);g.push(c(a))})}(a[f]));e.when.apply(e,y.map(b,function(a){var b=e.Deferred();a.always(function(){b.resolve()});return b.promise()})).done(function(){g.length&&k.auiSelect2("data",g)})}):(w(g,!1,!0),a.setValue=function(a){k.val(a);e.getJSON(u.CONTEXT_PATH+"/rest/api/user?accountId\x3d"+a).done(function(b){b&&b.accountId?k.auiSelect2("data",{id:b.accountId,text:b.displayName,
...
e("#macro-insert-container .macro-name").val(h);var k=e("#macro-insert-container .macro-input-fields form");k.empty();var l=c.extendedDescription||c.description;if(p)b.documentationLink&&d.UI.setHelpLink(d.dialog,{href:b.documentationLink});else if(l||b.documentationLink)l=e(r.MacroBrowser.macroDescription({descriptionHtml:l,documentationLink:b.documentationLink})),k.append(l);d.isInFabricEditor()&&b.body&&"PLAIN_TEXT"===b.body.bodyType?(e("#macro-insert-container #macro-preview-container").hide(),
e("#macro-insert-container #macro-body-editor-container").show(),b=f&&f.params&&"string"===typeof f.params.__bodyContent?f.params.__bodyContent:"",e("#macro-insert-container #macro-body-editor-container textarea").val(b)):(e("#macro-insert-container #macro-preview-container").show(),e("#macro-insert-container #macro-body-editor-container").hide(),b.body&&"NONE"!=b.body.bodyType&&n&&e(n).hasClass("editor-inline-macro")&&(n=c.pluginKey,b.body.label==d.Utils.makeDefaultKey(n,h,"body","label")&&(b.body.label=
""),b.body.description==d.Utils.makeDefaultKey(n,h,"body","desc")&&(b.body.description=""),(b=z(b.body,d.selectedMacroDefinition))&&k.append(b)));var m=f?e.extend({},f.params):{},q=k;p&&(a=w.without(a,p),p=y.build({cqlParam:p,renderParams:a,cqlValue:m.cql,container:k,flagRequiredParam:x,paramChanged:d.paramChanged}),delete m.cql,q=p.elements.filter(".cql-render-fields"),p.loading.done(function(){d.paramChanged();d.Preview.previewMacro(c,f);d.UI.focusOnMacroDetailsFirstInput()}));e(a).each(function(){q.append(A(c,
this,g))});g&&"function"===typeof g.beforeParamsSet&&(m=g.beforeParamsSet(m,!f));e(a).each(function(){var a;a=""==this.name?d.selectedMacroDefinition?d.selectedMacroDefinition.defaultParameterValue:this.defaultValue:m[this.name];null!=a?delete m[this.name]:e(this.aliases).each(function(){m[this]&&(a=m[this],delete m[this])});null==a&&(a=this.defaultValue);null!=a&&d.fields[this.name].setValue(a)});d.unknownParams=m;e("a",k).click(function(){u.open(this.href,"_blank").focus();return!1});e("#macro-browser-dialog:visible").length||
...
function(n,d,f,q,r,p,t,u,v,w,x,y,h,k,z){var a={};p=p(a);a.ParameterFields=p.ParameterFields;a.Field=p.Field;x(a,a.ParameterFields);a.Utils=q;a.Editor=r(a);a.Preview=u(a);a.Model=t(a);a.Rest=v;a.UI=w(a);var g,m=function(b,c){var e={id:b.macroName,successCallback:function(b){b&&b.details&&(b.details=a.Model.transformMetaDataDefault(b.details));a.Editor.loadMacroInBrowser(b.details,c);m.displayDetails();a.Preview.previewMacro(b.details)},errorCallback:function(a){f.trigger("analytics",{name:"macro-browser.fetch-metadata-error"});
n.alert("There has been an error loading the macro browser. Please try again or see your system administrator.");m.displayDetails()}};b.alternateId&&(e.alternateId=b.alternateId);m.setUI(c,b.title);a.Rest.fetchMacroMetadataDetails(e)};m.setUI=function(b,c){var e="edit"==b?a.editTitle:a.insertTitle;d("#macro-insert-container").hide();a.UI.updateButtonText(b);a.UI.enableSaveButton(!1);a.dialog.gotoPage(1).addHeader(e.replace(/\{0\}/,c));a.dialog.show();a.UI.showBrowserSpinner(!0)};m.displayDetails=function(){a.UI.showBrowserSpinner(!1);a.UI.enableSaveButton(!1);
d("#macro-insert-container").show();a.UI.focusOnMacroDetailsFirstInput()};a.isInTinyMceEditor=function(){return n.tinymce&&!!n.tinymce.activeEditor};a.isInFabricEditor=function(){return!a.isInTinyMceEditor()};a.reset=function(){g&&g.resolve&&g.resolve();g=null;a.initMacroBrowserAfterRequest=null;a.initData=null;a.hasInit=!1;a.metadataList=[];a.aliasMap={};a.fields={};h.reset();a.Macros=h.elements()};a.getMacroJsOverride=h.get;a.setMacroJsOverride=h.put;a.Macros=h.elements();a.hasInit=!1;a.metadataList=
[];a.aliasMap={};a.fields={};a.processRequiredParameters=function(){return a.Editor.processRequiredParameters()};a.paramChanged=function(){a.Editor.processRequiredParameters()};a.loadMacroInBrowser=function(b,c){a.Editor.loadMacroInBrowser(b,c)};a.getMacroDefinitionFromForm=function(b){a.Editor.getMacroDefinitionFromForm(b)};a.getMacroParametersFromForm=function(b){a.Editor.getMacroParametersFromForm(b)};a.previewMacro=function(b){a.Preview.previewMacro(b)};a.previewOnload=function(b){var c=a.dialog&&
a.dialog.activeMetadata&&a.dialog.activeMetadata.macroName||null;c&&((c=h.getFunction(c,"postPreview"))&&c(d("#macro-preview-iframe")[0],a.dialog.activeMetadata),f.Editor.disableFrame(b),d(b).click(function(a){if("a"===a.target.tagName.toLowerCase())return(a=d(a.target).attr("href"))&&0!=a.indexOf("#")&&-1==a.indexOf(n.location)&&n.open(a,"_blank").focus(),!1}))};a.getMacroMetadata=function(b){for(var c=0,e=a.metadataList.length;c<e;c++){var d=a.metadataList[c];if(d.macroName==b)return d}return null};
a.getMetadataPromise=function(){return g};a.open=function(b){b||(b={},k.log("No settings to open the macro browser."));var c=b.selectedMacro;!c&&b.presetMacroMetadata&&(c={name:b.presetMacroMetadata.macroName});if(c&&c.name){var e=h.getFunction(c.name,"opener");if(e){a.isInFabricEditor()&&c.params&&"string"===typeof c.params.__bodyContent&&(c.body=c.params.__bodyContent);b&&(a.settings=b);e(c);return}}a.hasInit?a.openMacroBrowser(b):(k.debug("init macro browser"),a.UI.showBrowserSpinner(!0),null!==
a.initData&&d.isEmptyObject(a.initData)?(f.trigger("analytics",{name:"macro-browser.init-reattempt"}),k.error("Macro browser preload failed. Trying again..."),a.initMacroBrowserAfterRequest=b,a.preLoadMacro()):a.initData?(a.initBrowser(),a.openMacroBrowser(b),a.updateCacheInBackground()):(f.trigger("analytics",{name:"macro-browser.init-overlap"}),k.debug("Waiting for macro browser preloading..."),a.initMacroBrowserAfterRequest=b))};a.openMacroBrowser=function(b){a.settings=b;a.selectedMacroDefinition=
b.selectedMacro;var c=a.selectedMacroDefinition&&a.selectedMacroDefinition.name||b.presetMacroName;b.presetMacroName&&(b.presetMacroMetadata=a.getMacroMetadata(b.presetMacroName));var e=b.presetMacroMetadata;if(!e){var l=b.selectedMacro;if(l){var c=l.name.toLowerCase(),c=a.aliasMap[c]||c,f=h.getFunction(c,"updateSelectedMacro"),g=h.getFunction(c,"getMacroDetailsFromSelectedMacro");f&&f(l);g&&(e=g(a.metadataList,l));e||(e=a.getMacroMetadata(c))}}l=d("#macro-browser-dialog").find("button.back");e?(k.debug("Open macro browser to edit macro: "+
e.macroName),l.hide(),a.replicateSelectMacro(e,b.mode||"edit")):c?(l.show(),a.dialog.overrideLastTab(),a.dialog.gotoPage(2),a.showBrowserDialog()):(l.show(),b.selectedCategory?(c=d("#select-macro-page .dialog-page-menu button").index(d("#category-button-"+b.selectedCategory)),0>c&&(c=0),a.dialog.overrideLastTab(),a.dialog.gotoPanel(0,c)):a.dialog.gotoPage(0),a.showBrowserDialog(),a.dialog.searcher.focusAndSearch(b.searchText))};a.showBrowserDialog=function(){a.dialog.show();a.UI.showBrowserSpinner(!1)};
a.complete=function(b){if(d("#macro-browser-dialog .dialog-button-panel .ok").is(":visible:not(:disabled)")){b=a.dialog.activeMetadata;var c=h.getFunction(b.macroName,"manipulateMarkup");c&&c(b);c=a.Editor.getMacroDefinitionFromForm(b);a.afterComplete(c,b)}};a.afterComplete=function(b,c){a.settings&&!1!==a.settings.autoClose&&a.close();if(a.settings&&"function"===typeof a.settings.onComplete)a.settings.onComplete(b,c)};a.cancel=function(){a.close();if(a.settings&&"function"===typeof a.settings.onCancel)a.settings.onCancel();
return!1};a.close=function(){this.unknownParams={};this.fields={};a.Preview.removePreviewContainer();this.dialog&&this.dialog.hide()};a.replicateSelectMacro=function(a,c){m(a,c)};a.initBrowser=function(){var b=a.initData;if(!b.categories||!a.metadataList.length)return f.trigger("analytics",{name:"macro-browser.init-browser-error"}),n.alert("There has been an error loading the macro browser. Please try again or see your system administrator."),a.UI.showBrowserSpinner(!1),!1;a.editTitle=b.editTitle;a.insertTitle=b.insertTitle;var c;b.categories=d.map(b.categories,
function(a){return"hidden-macros"==a.name?(c=a,null):a});b.categories.sort(function(a,b){return a.displayName.toLowerCase()>b.displayName.toLowerCase()?1:-1});c&&f.params.showHiddenUserMacros&&b.categories.push(c);a.dialog=a.UI.createDialog({title:b.title,categories:b.categories,macros:a.metadataList,onClickMacroSummary:function(a,b){a.preventDefault();m(b,"insert")},onSubmit:a.complete,onCancel:a.cancel});return a.hasInit=!0};a.searchSummaries=function(b,c){c=d.extend({splitRegex:/[\s\-]+/},c);return f.filterBySearch(a.metadataList,
b,c)};a.getMacroBody=function(){var b="";a.isInFabricEditor()&&d("#macro-insert-container .macro-body-editor textarea").is(":visible")?b=d("#macro-insert-container .macro-body-editor textarea").val():d("#macro-insert-container .macro-body-div textarea").length?b=d("#macro-insert-container .macro-body-div textarea").val():a.selectedMacroDefinition?a.selectedMacroDefinition.body&&(b=a.selectedMacroDefinition.body):a.dialog.activeMetadata&&(b=a.dialog.activeMetadata.formDetails.body.content);return b};
a.getMacroParams=function(a){return y.deserialize(a.getAttribute("data-macro-parameters"))};a.getMacroName=function(a){if(a&&a.hasAttribute("data-macro-name"))return a.getAttribute("data-macro-name")};a.isHiddenMacroShown=function(a){return f.params.showHiddenUserMacros&&"_-user-macro-_"==a.pluginKey};a.hasRequiredParameters=function(a){return a.anyParameterRequired};a.setWhitelist=function(b){a.whitelist=b};a.updateCacheInBackground=function(){a.Rest.loadMacroMetadata({data:a.whitelist?{whitelist:a.whitelist}:
{detailed:!1},forceUpdateCache:!0,errorCallback:function(a){k.error("Error updating cached macro browser metadata:");k.error(a)}})};a.preLoadMacro=function(b){b=b||{};a.initData=null;return g&&"pending"===g.state()&&!b.forceUpdateCache?g:g=a.Rest.loadMacroMetadata({data:a.whitelist?{whitelist:a.whitelist}:{detailed:!1},forceUpdateCache:b.forceUpdateCache,successCallback:function(b){a.initData=b;a.Model.loadMacros(b.macros);a.initMacroBrowserAfterRequest&&(a.initBrowser(),a.openMacroBrowser(a.initMacroBrowserAfterRequest))},
errorCallback:function(b){f.trigger("analytics",{name:"macro-browser.preload-error"});k.error("Error requesting macro browser metadata:");k.error(b);a.initData={}}})};return a});require("confluence/module-exporter").exportModuleAsGlobal("confluence-macro-browser/macro-browser","AJS.MacroBrowser");
}catch(e){WRMCB(e)};
;
try {
