...
function test(tag){
    ...
    for(var i=0;i <_pro.length;i++){
        ...
        if(_reg.test(pro_name)){
            ...
            _adicon1.style.backgroundImage='url(//www.yesky.com/TLimages2009/yesky/images/pic/adtips.png)';
            ...
            _adicon2.style.backgroundImage='url(//www.yesky.com/TLimages2009/yesky/images/pic/adtips.png)';
