...
$(document).ready(function(){
	//加载当前位置下方广告
	(function(){
		$("#ad-position-bottom").html('<a href="https://mp.weixin.qq.com/s/-MLNpcKlWiEGEpTJfXPPkw" target="_blank"><img width="100%" src="/uploads/ads/ad_position_bottom_wap.gif?v=' + window.cmsTempletsVer + '" /></a>');
	})();
	//加载文章上方广告
	(function(){
		var adArcTop =  $("#ad-arc-top").children();
		//图片广告
		adArcTop.first().html('<a href="https://mp.weixin.qq.com/s/-MLNpcKlWiEGEpTJfXPPkw" target="_blank"><img width="100%" src="/uploads/ads/ad_arc_top.gif?v=' + window.cmsTempletsVer + '" /></a>');
		//文字广告
