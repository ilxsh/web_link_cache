...
var tbtn = document.getElementById("tmode-btn");
function nmode() {
	...
	if(tbtn){
          tbtn.classList.remove("fa-moon-o");
          tbtn.classList.add("fa-sun-o");}
}
function dmode() {
        ...
        if(tbtn){
         tbtn.classList.remove("fa-sun-o");
         tbtn.classList.add("fa-moon-o");}
}
/*!
...
if (typeof tmode !="undefined"){
        if (Cookies.get(tmode) != 'dark'){
                Cookies.set(tmode, 'dark'); nmode();}
        else {
                Cookies.set(tmode, 'light'); dmode();}
        Cookies.set(tmo+'_mualmode','1');
} else{
        if (Cookies.get('tmode') != 'dark'){
                Cookies.set('tmode','dark'); nmode();}
        else {
