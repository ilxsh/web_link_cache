...
(function(n,e){e("ac/confluence/macro/editor",["ac/confluence/macro","ac/confluence/macro/bookmark","ajs","ac/confluence/utils"],function(f,g,h,e){var k;return{close:function(){connectHost.dialog.close()},getMacroData:function(a){return a(f.getCurrentMacroParameters())},getMacroBody:function(a){return a(k)},openCustomEditor:function(a,b){var c;if(!e.isFabricEditor()){h.Rte.getEditor().focus();var d=h.Rte.getEditor().selection.getNode();c=g.createBookmark();f.setLastSelectedConnectMacroNode(d)}f.setUnsavedMacroData(a.name,
a.body?a.body:"",a.params,c);k=a.body;c={addon_key:b.addonKey,key:a.name};var d=b.width||null,l=b.height||null,m={header:a.params?b.editTitle:b.insertTitle,submitText:a.params?"Save":"Insert",width:d,height:l,onHide:g.destroyBookmark};"100%"!==d&&"100%"!==l&&(m.chrome=!0);connectHost.dialog.create(c,m)}}})})(AJS.$,define);
}catch(e){WRMCB(e)};
;
try {
