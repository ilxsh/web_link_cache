...
var ContentRoadBlock='/interstitial/samplecontent.htm';

if(fid=='forum31X'){console.log('its 31');
	ContentRoadBlock='/interstitial/forum31.html';
	};

if(fid=='forum38'){console.log('its 38');
	ContentRoadBlock='/interstitial/forum38.html';
	};

if(fid=='forum39'){console.log('its 39');
	ContentRoadBlock='/interstitial/forum39.html';
	};

if(fid=='forum47'){console.log('its 47');
	ContentRoadBlock='/interstitial/forum47.html';
	};
