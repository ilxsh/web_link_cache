function create_menu(basepath)
{
    ...
    var base="http://www.scanmon.com/wiki/linux_unix/nginx_cn/";
	...
	document.write(
		...
		'<ul>' +
			...
			'<li><a href="'+base+'general/whyuseit.html">为什么选择 Nginx ？</a></li>' +
			'<li><a href="'+base+'general/install.html">安装 Nginx</a></li>' +
			'<li><a href="'+base+'general/commandline.html">运行和控制 Nginx - 命令行参数和信号</a></li>' +
