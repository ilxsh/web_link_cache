...
p.nominalBounds = new cjs.Rectangle(0,0,108,54);


(lib.yiyewener = function() {
	this.initialize(img.yiyewener);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,216,18);
...
// stage content:
(lib.wanyao300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层_4
	this.instance = new lib.yuanjiand("synched",0);
	this.instance.setTransform(208,157,1,1,0,0,0,136,8);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:178,alpha:1},14).wait(95).to({startPosition:0},0).to({alpha:0},10).wait(1));
	...
	this.instance_2.setTransform(52.5,15.5,1,1,0,0,0,52.5,15.5);
