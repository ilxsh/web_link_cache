 ...
 * 二级域名 getSecondaryDomain
  ...
  //  festival customize
    var start_time = 1548777600, // toolbar 特殊样式起始时间戳new Date(2018,11,29).getTime()/1000
        end_time = 1550592000,  // toolbar 特殊样式结束时间戳
        ...
        // }
        if(now_time > start_time && now_time < end_time ){
          logo_tpl = '<img src="//csdnimg.cn/cdn/content-toolbar/spring-logo.png">';
          logo_title = 'csdn-spring';
        }
  ...
  var tpl ='\<div id="csdn-toolbar" class="csdn-toolbar tb_disnone '+skin+fixed+'">\
        <div class="container row center-block ">\
          <ul class="pull-left left-menu clearfix" id="nav-left-menu">\
            ...
            <li><a href="//www.csdn.net/" class="toolbar_to_feed" title="首页" style="margin-left:8px">首页</a></li>\
          ...
          <div class="pull-right login-wrap '+loginMark+'">\
            ...
            <li class="toolbar-tracking csdn-tracking-statistics tracking-click" data-mod="popu_369"><a href="#" style="padding:0"></a></li>\
              ...
              <li class="write-bolg-btn csdn-tracking-statistics tracking-click gitChat" data-mod="popu_370"><a class="" href="//mp.csdn.net/postedit" target="_blank"><img src="https://csdnimg.cn/public/common/toolbar/images/spring/xieboke.png" alt="" class="money"><span>写博客</span></a></li>\
              <li class="gitChat"><a class="" href="//gitbook.cn/new/gitchat/activity?utm_source=csdnblog1" target="_blank"><img src="https://csdnimg.cn/public/common/toolbar/images/spring/money.png" alt="" class="money"><span>赚零钱</span></a></li>\
              <li class="gitChat upload"><a target="_blank" class="" href="//i.csdn.net/#/msg/index"><img src="https://csdnimg.cn/public/common/toolbar/images/spring/message-icon.png" alt="" class="message"><span>消息</span><div class="toolbar-circle" id="msg-circle"></div></a></li>\
