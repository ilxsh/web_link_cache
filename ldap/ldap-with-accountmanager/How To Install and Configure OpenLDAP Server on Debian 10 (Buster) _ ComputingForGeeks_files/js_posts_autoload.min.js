...
tdbAutoload._locationChange()},10);"on"===g&&(d.scroll(b),d.scroll(q),d.resize(p),ezoicSiteSpeed({objOrFunction:d.resize, object:d, function: "resize"}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){}),ezoicSiteSpeed({objOrFunction:d.scroll, object:d, function: "scroll"}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){}))}},_fixSmartSidebar:function(){var a=d.scrollTop(),g=a+d.height();f(".tdb-autoload-wrap").find("iframe").each(function(){var b=f(this),c=b.offset().top-f("#wpadminbar").outerHeight(),d=b.outerHeight(!0);b=b.attr("id");c<a&&c+d>g&&document.getElementById(b).contentWindow.tdSmartSidebar.td_events_scroll(a-c)})},_locationChange:function(){var a=d.scrollTop(),g=a+d.height(),
