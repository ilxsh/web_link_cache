...
var guestpay_alipay = 1;var guestpay_weixin = 1;var guestpay_kucatpay = 0;var guestpay_alipayf2f = 1;
var lcp = {
    ...
    loginback: 'https://www.huakings.cn/MemberCenter/LoginSuccess.html',
    tcaptcha_enable: 1,
    ajaxurl: ajaxurl + 'laycenter&target=',
    csrfToken: '550a8dabc3ed39131a7dafac1bf34469',
    membercenter: 'https://www.huakings.cn/MemberCenter',
    loginurl: 'https://www.huakings.cn/MemberCenter/Login.html',
    download_innewtab: 0,
    ...
    notice: function(must){
        let md5 = '0fc00b6989e1614a5e681d6973dc8be9';
        let show = '1';
        ...
        layui.use('layer', function(){
            ...
            layer.open({
                ...
                ,btnAlign: 'c'
                ,moveType: 1
                ,content: '<div style="padding: 15px;line-height: 22px;">网站公告内容，全页面可弹出，只要点击已读，下次就不会自动弹出。除非管理员修改了公告内容，或清除cookie</div>'
                ,end: function(){
    ...
    tcaptcha: function(success, cancel, fail){
        ...
        if (!zbp.cookie.get('ticket')){
            new TencentCaptcha('2002827374', function(res) {
                if (res.ret === 0){
