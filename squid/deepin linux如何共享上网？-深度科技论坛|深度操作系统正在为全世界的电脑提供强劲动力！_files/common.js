...
function showTopLink() {
	...
	if(ft){
		...
		if (basew < 1000) {
			...
			scrolltop.style.right = document.documentElement.clientWidth - wp.offsetLeft - wp.clientWidth - scrolltop.clientWidth + 'px';
		}
		...
		if (scrollHeight < -100) {
			// scrolltop.className+=scrolltop.className.replace('bounceInRight','')+" animated bounceInRight";
			if(!jQuery('#scrolltop').hasClass("bounceInRight")){jQuery('#scrolltop').removeClass("bounceOutRight").addClass("bounceInRight")}
			scrolltop.style.visibility = 'visible';
		} else {
			// scrolltop.style.visibility = 'hidden';
			if(!jQuery('#scrolltop').hasClass("bounceOutRight")){jQuery('#scrolltop').removeClass("bounceInRight").addClass("bounceOutRight")}
			// scrolltop.className+=scrolltop.className.replace('bounceInRight','')+" bounceOutRight";
		}
	}
}
